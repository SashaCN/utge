...
@section('content')
    ...
    <form id="form" action="{{ route('childPage.store') }}" method="POST" enctype="multipart/form-data" class="current-slide-wrap">
        ...
        <div class="desc-slide flex-col">
            <div class="input-wrap"><div class="content">
                <div id="editparent">
                  <div id='editControls' style='text-align:center; padding:5px;'>
                    ...
                    <div class='btn-group'>
                      <a class='btn' data-role='switchEditor' href='#' title='Перейти в редактор коду'>&lt;code&gt;</a>
                    </div>
                  </div>
                  <div id='editor' style='' contenteditable></div>
                  <textarea id="code" name="description_uk" id="desc_uk" ></textarea>
                </div>
              </div>
