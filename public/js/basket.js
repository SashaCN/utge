window.onload = () => {
    ...
    function pushToLocalStorage() {
        ...
        // localStorageBasket.forEach(e => {
        //     if (localStorageBasket[i]['id'] == productsMass[i]['id'] && localStorageBasket[i]['size'] == productsMass[i]['size']) 
        //     {
        //         localStorageBasket[i]['quantify'] = productsMass[i]['quantify'];
        //     }
        // });
